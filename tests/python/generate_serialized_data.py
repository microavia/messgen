...
if __name__ == "__main__":
    ...
    # simple_struct
    t = codec.type_serializer("messgen/test/simple_struct")
    msg1: dict[str, Any] = {
    ...
    # var_size_struct
    t = codec.type_serializer("messgen/test/var_size_struct")
    msg1 = {
        "f0": 0x1234567890abcdef,
    ...
    # struct_with_enum
    t = codec.type_serializer("messgen/test/struct_with_enum")
    msg1 = {
        "f0": 0x1234567890abcdef,
        "f1": 0x1234567890abcdef,
        "e0": "another_value"
    ...
    # empty_struct
    t = codec.type_serializer("messgen/test/empty_struct")
    msg1 = {}
    b = t.serialize(msg1)
    ...
    t = codec.type_serializer("messgen/test/complex_struct_with_empty")
    msg1 = {
        "e": {},  # empty_struct
    ...
    t = codec.type_serializer("messgen/test/complex_struct_nostl")
    simple_struct = {
        "f0": 0x1234567890abcdef,
        "f1": 0x1234567890abcdef,
        "f1_pad": 0x12,
    ...
    # complex_struct
    t = codec.type_serializer("messgen/test/complex_struct")
    ...
    t = codec.type_serializer("messgen/test/flat_struct")
    msg1 = {
        "f0": 0x1234567890abcdef,
        "f1": 0x1234567890abcdef,
        "f1_pad": 0x12,
